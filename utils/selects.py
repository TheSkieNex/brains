...
class CapSelect(discord.ui.Select):
    def __init__(self, bot: bot.Qolga, groups: list[str], member: discord.Member):
        options = [
        ...
        self.bot = bot
        self.member = member
        super().__init__(placeholder='აირჩიე ჯგუფი', options=options, min_values=1, max_values=1, custom_id='qolga:cap_select')
